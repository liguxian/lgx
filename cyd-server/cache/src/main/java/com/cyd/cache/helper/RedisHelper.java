...
public class RedisHelper {
    ...
    public static long delKey(final Set key) {
     ...
     * @param value 值
     */
    public static void setValueNoTTL(final String key, final Object value) {
     ...
     * @return Hash中的对象
     */
    public static <T> T hashCacheShell(final String key, final String hKey, Class<T> tClass, Function<String, T> fun) {

        Object o = hashGet(key, hKey);
        if (ObjectUtil.isNull(o)) {
            ...
            T t = JSONUtil.toBean(toJsonStr, tClass);
            return t;
        }
        return (T) o;
    }
     ...
     * @return Hash对象集合
     */
    public static long hashDeleteKeys(final String key, final Object... hKeys) {
        return redisTemplate.opsForHash().delete(key, hKeys);
    }
     ...
     * @return 存入的个数
     */
    public static long zSet(final String key, final Set<ZSetOperations.TypedTuple<Object>> values) {
    ...
    public static long leftPushAll(final String key, final Collection<Object> values) {
