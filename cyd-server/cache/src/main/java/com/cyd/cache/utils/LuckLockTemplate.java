...
public interface LuckLockTemplate {
     ...
     * @return 锁对象
     */
    ZLock lock(String key, long leaseTime, TimeUnit unit, boolean isFair);

    default ZLock lock(String key, long leaseTime, TimeUnit unit)  {
        return this.lock(key, leaseTime, unit, false);
    }
    default ZLock lock(String key, boolean isFair) throws InterruptedException {
        return this.lock(key, -1, null, isFair);
    }
    default ZLock lock(String key) throws InterruptedException {
    ...
    default ZLock tryLock(String key, long waitTime, TimeUnit unit) throws InterruptedException {
   ...
   ZLock readLock(String key) throws InterruptedException;

   ZLock writeLock(String key) throws InterruptedException;

   void unReadLock(Object lock);

   void unWriteLock(Object lock);
}
